...
* **ActivityWatch** ([releases](https://github.com/ActivityWatch/activitywatch/releases) ⭐ 18,915 | 🐛 185 | 🌐 Python | 📅 2026-09-15) - The official distribution, includes:
...
* [aw-tauri](https://github.com/ActivityWatch/aw-tauri) ⭐ 67 | 🐛 15 | 🌐 Rust | 📅 2026-09-16 (WIP), experimental/alternative distribution of ActivityWatch using Tauri
...
* [aw-server-rust](https://github.com/ActivityWatch/aw-server-rust) ⭐ 315 | 🐛 81 | 🌐 Rust | 📅 2026-09-16, an official server implementation written in Rust for improved performance
* [aw-server](https://github.com/ActivityWatch/aw-server) ⭐ 128 | 🐛 28 | 🌐 Python | 📅 2026-09-10, an official server implementation written in Python
...
* [aw-client-rust](https://github.com/ActivityWatch/aw-server-rust/tree/master/aw-client-rust) ⭐ 315 | 🐛 81 | 🌐 Rust | 📅 2026-09-16, a client library written in Rust
...
* [aw-sync](https://github.com/ActivityWatch/aw-server-rust/tree/master/aw-sync) ⭐ 315 | 🐛 81 | 🌐 Rust | 📅 2026-09-16, the official sync-with-folder/bring-your-own-sync solution for ActivityWatch
...
* [Awesome Quantified Self](https://github.com/woop/awesome-quantified-self) ⭐ 2,773 | 🐛 45 | 📅 2026-07-06, a list of awesome quantified self resources

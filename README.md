...
* **ActivityWatch** ([releases](https://github.com/ActivityWatch/activitywatch/releases) ⭐ 18,985 | 🐛 185 | 🌐 Python | 📅 2026-09-24) - The official distribution, includes:
...
* [aw-tauri](https://github.com/ActivityWatch/aw-tauri) ⭐ 67 | 🐛 17 | 🌐 Rust | 📅 2026-09-23 (WIP), experimental/alternative distribution of ActivityWatch using Tauri
...
* [aw-server-rust](https://github.com/ActivityWatch/aw-server-rust) ⭐ 318 | 🐛 91 | 🌐 Rust | 📅 2026-09-24, an official server implementation written in Rust for improved performance
...
* [aw-client-rust](https://github.com/ActivityWatch/aw-server-rust/tree/master/aw-client-rust) ⭐ 318 | 🐛 91 | 🌐 Rust | 📅 2026-09-24, a client library written in Rust
* [aw-client](https://github.com/ActivityWatch/aw-client) ⭐ 71 | 🐛 14 | 🌐 Python | 📅 2026-09-25, a client library written in Python
...
* [aw-watcher-window](https://github.com/ActivityWatch/aw-watcher-window) ⭐ 130 | 🐛 34 | 🌐 Python | 📅 2026-09-15 - Watches the active window and its metadata
* [aw-watcher-afk](https://github.com/ActivityWatch/aw-watcher-afk) ⭐ 77 | 🐛 12 | 🌐 Python | 📅 2026-08-31 - Watches for mouse & keyboard activity to detect if the user is active

## Window Watchers :desktop\_computer:

* [awatcher](https://github.com/2e3s/awatcher) ⭐ 308 | 🐛 29 | 🌐 Rust | 📅 2026-09-23 - A compiled watcher for X11 and Wayland by @2e3s
* [aw-watcher-window](https://github.com/ActivityWatch/aw-watcher-window) ⭐ 130 | 🐛 34 | 🌐 Python | 📅 2026-09-15 - The official window watcher for Windows, macOS, and Linux (X11)
...
* [aw-watcher-sublime](https://github.com/kostasdizas/aw-watcher-sublime) ⭐ 17 | 🐛 3 | 🌐 Python | 📅 2025-05-27 - Sublime Text 3 by @kostasdizas
...
* [aw-watcher-tmux](https://github.com/akohlbecker/aw-watcher-tmux) ⭐ 95 | 🐛 6 | 🌐 Shell | 📅 2024-02-05 - Monitors tmux sessions by @akohlbecker
...
* [aw-sync](https://github.com/ActivityWatch/aw-server-rust/tree/master/aw-sync) ⭐ 318 | 🐛 91 | 🌐 Rust | 📅 2026-09-24, the official sync-with-folder/bring-your-own-sync solution for ActivityWatch
...
* [Awesome Quantified Self](https://github.com/woop/awesome-quantified-self) ⭐ 2,778 | 🐛 51 | 📅 2026-07-06, a list of awesome quantified self resources

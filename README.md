...
* [aw-tauri](https://github.com/ActivityWatch/aw-tauri) ⭐ 62 | 🐛 19 | 🌐 Rust | 📅 2026-08-03 (WIP), experimental/alternative distribution of ActivityWatch using Tauri
...
* [aw-server-rust](https://github.com/ActivityWatch/aw-server-rust) ⭐ 311 | 🐛 61 | 🌐 Rust | 📅 2026-08-10, an official server implementation written in Rust for improved performance
...
* [aw-client-rust](https://github.com/ActivityWatch/aw-server-rust/tree/master/aw-client-rust) ⭐ 311 | 🐛 61 | 🌐 Rust | 📅 2026-08-10, a client library written in Rust
* [aw-client](https://github.com/ActivityWatch/aw-client) ⭐ 67 | 🐛 14 | 🌐 Python | 📅 2026-07-23, a client library written in Python
...
* [aw-watcher-window](https://github.com/ActivityWatch/aw-watcher-window) ⭐ 127 | 🐛 34 | 🌐 Python | 📅 2026-08-17 - Watches the active window and its metadata
...
* [awatcher](https://github.com/2e3s/awatcher) ⭐ 302 | 🐛 33 | 🌐 Rust | 📅 2026-07-31 - A compiled watcher for X11 and Wayland by @2e3s
...
* [aw-import-screentime](https://github.com/ActivityWatch/aw-import-screentime) ⭐ 83 | 🐛 6 | 🌐 Python | 📅 2026-07-27 - Import macOS Screen Time data into ActivityWatch (official)
...
* [aw-sync](https://github.com/ActivityWatch/aw-server-rust/tree/master/aw-sync) ⭐ 311 | 🐛 61 | 🌐 Rust | 📅 2026-08-10, the official sync-with-folder/bring-your-own-sync solution for ActivityWatch
...
* [Awesome Quantified Self](https://github.com/woop/awesome-quantified-self) ⭐ 2,757 | 🐛 35 | 📅 2026-07-06, a list of awesome quantified self resources
